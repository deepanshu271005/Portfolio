...
const skills = [
  ...
  { name: "CSS", level: 95, category: "web" },
  ...
  // Concepts
  { name: "OOPS", level: 95, category: "concepts" },
  { name: "DSA", level: 95, category: "concepts" },
];

const categories = ["all", "languages", "web", "databases", "tools", "concepts"];
